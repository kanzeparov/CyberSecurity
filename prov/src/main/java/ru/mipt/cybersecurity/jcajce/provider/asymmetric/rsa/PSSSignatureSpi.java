...
import ru.mipt.cybersecurity.jcajce.provider.util.DigestFactory;
    ...
    extends SignatureSpi
{
    ...
    private ru.mipt.cybersecurity.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return ru.mipt.cybersecurity.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new ru.mipt.cybersecurity.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(false,
